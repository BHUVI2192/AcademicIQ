-- ============================================================================
-- Migration: Fix publish_test_marks RPC (040)
-- ============================================================================
-- Ensures publish_test_marks checks test.marks_status = 'approved' before publishing.
-- This migration drops the existing function and recreates it with the corrected logic.
