-- ============================================================================
-- Migration: Make publish_test_marks SECURITY DEFINER (041)
-- ============================================================================
-- The publish_test_marks function inserts rows into public.rankings.
-- Since public.rankings has Row Level Security enabled but no write policies for
-- authenticated users (only service_role/owner can write), the function must be
-- defined as SECURITY DEFINER to bypass RLS checks and execute successfully.
